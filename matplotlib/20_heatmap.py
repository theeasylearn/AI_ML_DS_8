...
import numpy as np 
# 2D List: 10 Cities x 30 Days Temperature Data (April 2026) for Gujarat
# Rows: Ahmedabad, Surat, Vadodara, Rajkot, Bhavnagar, Jamnagar, Bhuj, Gandhinagar, Junagadh, Dwarka
# Columns: Day 1 to Day 30 of April
list = [
...
plt.imshow(array_2d,cmap='cool',interpolation='nearest')
plt.xlabel('dates')
plt.xticks(ticks=range(1,30))
plt.ylabel('temprature')
plt.title('10 cities temprature in april 2026')
plt.colorbar()
plt.show()
